...
!function(n, t) {
    ...
    var At = "slide"
      ...
      , Mt = "fade";
    function zt(o, e, t, r) {
        var i, n = Gn(o), u = n.on, s = n.emit, c = n.bind, a = o.Components, f = o.root, l = o.options, d = l.isNavigation, p = l.updateOnMove, h = l.i18n, v = l.pagination, g = l.slideFocus, m = a.Direction.resolve, y = K(r, "style"), b = K(r, Vn), w = -1 < t, E = A(r, "." + at), S = tn(r, l.focusableNodes || "");
        function x() {
    ...
    var Xt = Object.freeze({
        ...
        Slides: function(i, o, r) {
            ...
            return {
                ...
                add: function(n, o) {
                    y(n, function(n) {
                        var t, e, i;
                        g(n = M(n) ? Z(n) : n) && ((t = c[o]) ? k(n, t) : C(a, n),
                        P(n, r.classes.slide),
                        n = n,
                        e = D(u, Nn),
                        n = tn(n, "img"),
        ...
        Clones: function(s, e, c) {
            ...
            function h() {
                var n, t = c.clones;
                return s.is(Dt) ? t || (t = (n = c[r("fixedWidth")] && e.Layout.slideSize(0)) && ln(Q(a.track)[r("width")] / n) || c[r("autoWidth")] && s.length || 2 * c.perPage) : t = 0,
                t
            }
            return {
                mount: function() {
        ...
        Move: function(i, s, o) {
            var c, n = Gn(i), t = n.on, a = n.emit, f = i.state.set, r = (n = s.Layout).slideSize, e = n.getPadding, u = n.totalSize, l = n.listSize, d = n.sliderSize, p = (n = s.Direction).resolve, h = n.orient, v = (n = s.Elements).list, g = n.track;
            function m() {
            ...
            return {
                ...
                move: function(n, t, e, i) {
                    ...
                    n !== t && (o = t < n,
                    r = h(w(x(), o)),
                    o ? 0 <= r : r <= v["scroll" + p("Width")] - Q(g)[p("width")]) && (E(),
                    b(w(u, t < n), !0)),
                    f(R),
                    a(Sn, t, e, n),
                    c.start(t, function() {
        ...
        Controller: function(r, o, u) {
            var s, i, c, n = Gn(r).on, a = o.Move, f = a.getPosition, l = a.getLimit, d = a.toPosition, t = o.Slides, p = t.isEnough, e = t.getLength, h = r.is(Dt), v = r.is(At), g = D(E, !1), m = D(E, !0), y = u.start || 0, b = y;
            function w() {
                s = e(!0),
                i = u.perMove,
                c = u.perPage;
            ...
            function S(n, t, e) {
                ...
                n = o,
                e = !1),
                n < 0 || i < n ? n = hn(0, n, t, !0) || hn(i, t, n, !0) ? P(C(n)) : h ? e ? n < 0 ? -(s % c || c) : s : n : u.rewind ? n < 0 ? i : 0 : -1 : e && n !== t && (n = P(C(t) + (n < t ? -1 : 1)))) : n = -1,
                n
            }
            function x(n) {
                return h ? (n + s) % s || 0 : n
                ...
                go: function(n, t, e) {
                    ...
                    A() || -1 < (n = x(i = function(n) {
                        var t = y;
                        {
                            ...
                            e = i[1],
                            i = i[2],
                            "+" === e || "-" === e ? t = S(y + +("" + e + (+i || 1)), y) : ">" === e ? t = i ? P(+i) : g(!0) : "<" === e && (t = m(!0))) : t = h ? n : vn(n, 0, _())
                        }
                        return t
                    }(n))) && (t || n !== y) && (k(n),
                    a.move(i, n, b, e))
        ...
        Scroll: function(r, s, u) {
            ...
            function w(n, t, e, i) {
                ...
                g(o + n),
                r.is(At) && !e && v() && (m *= .6,
                dn(n) < 10 && y(h(v(!0)), 600, !1, void 0, !0))
            }
            function E() {
                c && c.cancel()
            }
        ...
        Drag: function(r, i, u) {
            var s, t, o, c, a, f, l, d, n = Gn(r), e = n.on, p = n.emit, h = n.bind, v = n.unbind, g = r.state, m = i.Move, y = i.Scroll, b = i.Controller, w = i.Elements.track, E = i.Media.reduce, S = (n = i.Direction).resolve, x = n.orient, _ = m.getPosition, P = m.exceededLimit, C = !1;
            function k() {
                var n = u.drag;
                j(!n),
                c = "free" === n
            ...
            function L(n) {
                ...
                e = n.target,
                i = u.noDrag,
                B(e, "." + vt + ", ." + lt) || i && B(e, i) || !t && n.button || (b.isBusy() ? $(n, !0) : (d = t ? w : window,
                a = g.is([R, W]),
                o = null,
                h(d, kt, A, Tt),
                h(d, Lt, D, Tt),
            ...
            function D(n) {
                ...
                a && (function(n) {
                    ...
                    E(!1),
                    c ? b.scroll(e, 0, u.snap) : r.is(Mt) ? b.go(x(gn(t)) < 0 ? n ? "<" : "-" : n ? ">" : "+") : r.is(At) && C && n ? b.go(P(!0) ? ">" : "<") : b.go(b.toDest(e), !0);
                    E(!0)
                }(n),
                $(n)),
                v(d, kt, A),
